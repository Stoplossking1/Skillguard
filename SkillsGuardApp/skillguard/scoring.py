...
CODE_PRIORITY: dict[str, int] = {
    ...
    "LLM_PROMPT_INJECTION_DETECTED": 40,
    "YARA_command_injection": 41,
    "YARA_credential_harvesting": 42,
    "YARA_prompt_injection": 43,
    "YARA_code_execution": 44,
    "YARA_script_injection": 45,
    "MANIFEST_MISSING_LICENSE": 50,
    "MANIFEST_INVALID_NAME": 51,
    "TRIGGER_OVERLY_GENERIC": 52,
    "TRIGGER_KEYWORD_BAITING": 53,
    "BINARY_FILE_DETECTED": 54,
}
